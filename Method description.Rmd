...
This document describes the testing function for a relationship between  hypothesized cause and effect events. 
...
### 1.1. Develop the conceptual impact pathways
We conceptualized the impact pathway based on different sources of information including the project’s design, project’s logical framework, innovation diffusion literature and personal communication with key informants from the project.

```{r, out.width="90%", fig.align="center", fig.cap="The hypothesized agro-climate service (ACS) delivery and adoption impact pathway and the dynamics of ACS adoption in Village saving and loan association (VSLA) and conventional farmer group (non-VSLA) in Muong Phang and Pa Khoang communes, Dien Bien District, Vietnam.", echo=FALSE}
knitr::include_graphics('Figures-tables/Fig1. Adoption-Delivery-Adoption-Pathway-Dynamics.png', dpi=NA)
```

### 1.2. Farmer survey
`Questionaire.docx` contains the set of questions used in the farmer survey, aiming for testing the conceptual impact pathways. Download the survey tool from the [ACS-adoption-decision-pathway](https://github.com/ThiThuGiangLuu/ACS-adoption-decision-pathway)

### 1.3. Description of variables collected from farmer survey 

`diffusion-variable-description.xlsx` contains data for general statistics and for testing. The tables contains information including name of variable; description of variable, type of variable values and which question is the questionnaire was used to get the data for that variable. Download the table from the [ACS-adoption-decision-pathway](https://github.com/ThiThuGiangLuu/ACS-adoption-decision-pathway).

### 1.4. Data table 

The data table `diffusion.csv` contains surveyed data for general statistics and data used for testing. The table includes the variable names and its values. Download the table from the [ACS-adoption-decision-pathway](https://github.com/ThiThuGiangLuu/ACS-adoption-decision-pathway).
...
### 1.5. Development of the test function 
...
### 1.6. Implement the test for the agro-climate service delivery and adoption impact pathway
...
# 3. Annex with full R code of the model
