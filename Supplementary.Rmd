...
### h. Supplementary Information 5: Detailed results of the testing 

`SI5-detailed results of the tests.pdf` contains detailed results of all the tests. Download the [Results](https://github.com/ThiThuGiangLuu/ACS-adoption-decision-pathway/blob/master/SI5-detailed%20results%20of%20the%20tests.pdf).
